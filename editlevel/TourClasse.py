...
class Tours(object):
    ...
    def __init__(self, fichiertour, num, myfont1):
        ...
        self.image_menu = pygame.image.load(
            self.image_menu_load).convert_alpha()
        self.tourrect = pygame.Rect(
            (
                18 + (64*num) + (num*10),
                round((704) - (72))
            ), (64, 64)
    ...
    def affichemenu(self, fenetre, num):
        ...
        fenetre.blit(
            self.prix_affiche, (18 + (60*num) + (num*10), (704) - (72)))
...
class Tours_IG(object):
    ...
    def __init__(self, Type_Tour, num, ImgsDir):
        ...
        self.Tab_ImageRet = [
            pygame.transform.flip(c, True, False) for c in self.Tab_Image]
    ...
    def placetour(self, position_souris, fenetre, tableau, Liste, toursel, niveau):
        ...
        fenetre.blit(
            self.image,
            ((self.Position_IG[0]*64), (self.Position_IG[1]*64))
        )
    ...
    def Time2Impact(self, ennemi):
        ...
        b = (
            (2 * ennemi.vitesse * Cos_Beta)
            - (2 * self.vitesse_Projectile ** 2 * self.t0)
        )
