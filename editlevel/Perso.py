...
class Perso(object):
    def __init__(self):
        ...
        self.King_Attak = pygame.image.load(
            constantes.king_Attak).convert_alpha()
        self.King_Attak2 = pygame.image.load(
            constantes.king_Attak2).convert_alpha()
        self.King_1_ret = pygame.image.load(
            constantes.king_1Ret).convert_alpha()
        self.King_2_ret = pygame.image.load(
            constantes.king_2Ret).convert_alpha()
        self.King_3_ret = pygame.image.load(
            constantes.king_3Ret).convert_alpha()
        self.King_4_ret = pygame.image.load(
            constantes.king_4Ret).convert_alpha()
        self.King_5_ret = pygame.image.load(
            constantes.king_5Ret).convert_alpha()
        self.King_6_ret = pygame.image.load(
            constantes.king_6Ret).convert_alpha()
        self.King_Attak_ret = pygame.image.load(
            constantes.kingRet_Attak).convert_alpha()
        self.King_Attak2_ret = pygame.image.load(
            constantes.kingRet_Attak2).convert_alpha()

        self.Perso_Tab = [
            self.King_1, self.King_2, self.King_3,
            self.King_4, self.King_5, self.King_6]
        self.Perso_Tab_ret = [
            self.King_1_ret, self.King_2_ret, self.King_3_ret,
            self.King_4_ret, self.King_5_ret, self.King_6_ret]
    ...
    def vit(self, Liste_Mechants, niveau, Coin):
        ...
        if self.AnimAttak:
            ...
            if math.sqrt(((self.posx - self.target.PosAbsolue[0]) ** 2) + ((self.posy - self.target.PosAbsolue[1]) ** 2)) > self.Vitesse:
            ...
            if math.sqrt(((self.posx - self.targetCoordx) ** 2) + ((self.posy - self.targetCoordy) ** 2)) > self.Vitesse:
